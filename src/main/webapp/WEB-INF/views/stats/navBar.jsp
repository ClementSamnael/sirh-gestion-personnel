...
<nav class="navbar sticky-top navbar-expand-lg navbar-light bg-lights"
	...
	<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
		<div class="navbar-nav">
			<a class="nav-item nav-link active" href=<c:url value="lister"/>>Collaborateurs <span
				class="sr-only">(current)</span></a> <a class="nav-item nav-link"
				href=<c:url value="statistique"/>>Stastiques</a> <a class="nav-item nav-link" href="#">Activités</a>
		</div>
	</div>
</nav>